      ...
      <div className='main'>
        ...
        <div id="4" className={projetosPessoaisStyles.projectRight}>
          ...
          <div className={projetosPessoaisStyles.cardProject}>
            <h1>iCooking</h1>
            <div className={projetosPessoaisStyles.description}>
              <p>Aplicativo em Ionic realizado para o projeto interdisciplinar do ano anterior. O projeto tinha como propósito agilizar os processos de compra e retirada de produtos das cantinas da Unifil.</p>
            </div>
          </div>
        </div>
        ...
        <div id="5" className={projetosPessoaisStyles.project}>
          <div className={projetosPessoaisStyles.cardProject}>
            ...
            <div className={projetosPessoaisStyles.description}>
              <p>Projeto realizado para a aula do professor Edson Shinki Kaneshima no 1º semestre de 2020. Esse projeto tinha como objetivo inserir valores em posições vazias e não vazias de um array, retornar valores da primeira posição, do ultimo número e o array depois de fazer as alterações, remover elementos, verificar quantos elementos possui e converter esse array em String.</p>
            </div>
          </div>
